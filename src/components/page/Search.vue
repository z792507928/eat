<template>
  <div>
    <section class="app-3rd0G">
      ...
      <form class="app-ks58x" action="/api/find" method="get">
        <img src="data:image/png;base64,"
             class="app-ETjEK"><input type="search"
                                      autofocus="autofocus"
                                      placeholder="请输入商品名称"
                                      class="app-2jUwX" v-model="Storage">
        <button type="submit"
                class="app-1SphX" @click="search()">搜索
        </button>
      </form>
    </section>
    ...
    <section>
      ...
      <section class="app-1lQKU"><span class="app-1vu8i" v-for="item in StorageArr">
        {{ item }}
      </span></section>
    </section>
