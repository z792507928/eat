  ...
  <div>
    <header class="ElemeHeader-root_lOpLxr-_0">
      <div class="ElemeHeader-wrapper_2rUT4SE_0 ElemeHeader-fixed_3OoT0dS_0 ElemeHeader-gradientBg_3_Tu-JD_0"
        ...
        <h1 class="ElemeHeader-center_2hbxfGq_0">我的</h1></div>
    </header>
    <section>
      <div class="profile-3g0uv"><span class="profile-1gjgY"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <span class="profile-2XuMq"><svg fill="#fff"><use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                          xlink:href="#arrow-right"><svg viewBox="0 0 122 122" id="avatar-default" width="100%" height="100%"><path fill="#DCDCDC" fill-rule="evenodd" d="M61 121.5c33.413 0 60.5-27.087 60.5-60.5S94.413.5 61 .5.5 27.587.5 61s27.087 60.5 60.5 60.5zm12.526-45.806c-.019 3.316-.108 6.052.237 9.825 3.286 8.749 18.816 9.407 28.468 17.891-1.833 1.998-6.768 6.788-15 10.848-7.02 3.463-16.838 6.416-24.831 6.416-17.366 0-32.764-7.149-42.919-17.264 9.713-8.407 25.49-9.173 28.769-17.891.345-3.773.258-6.509.24-9.825l-.004-.002c-1.903-.985-5.438-7.268-6.01-12.571-1.492-.12-3.843-1.561-4.534-7.247-.37-3.053 1.107-4.77 2.004-5.31-5.046-19.212 1.507-33.16 20.749-34.406 5.753 0 10.18 1.52 11.909 4.523 15.35 2.702 11.756 22.658 9.328 29.882.899.54 2.376 2.258 2.004 5.31-.689 5.687-3.042 7.127-4.534 7.248-.575 5.305-3.25 10.82-5.873 12.57l-.003.003zM61 120.5C28.14 120.5 1.5 93.86 1.5 61S28.14 1.5 61 1.5s59.5 26.64 59.5 59.5-26.64 59.5-59.5 59.5z"></path></svg><svg viewBox="0 0 1024 1024" id="arrow-right" class="icon" width="100%" height="100%"><path d="M716.298 417.341l-.01.01L307.702 7.23l-94.295 94.649 408.591 410.117-408.591 410.137 94.295 94.639 502.891-504.76z" class="selected"></path></svg></use></svg></span></div>
    </section>
    <div class="index-1G7HV_0"><a href="javascript:;"
                                  class="index-1ryAh_0">
      <p>
        <svg fill="#ff5f3e">
          <use xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <p class="index-3S6cZ_0">优惠</p></a><a href="javascript:;"
                                            class="index-1ryAh_0">
      <p>
        <svg fill="#6ac20b">
          <use xmlns:xlink="http://www.w3.org/1999/xlink"
               xlink:href="#profile-coins">
      ...
      <p class="index-3S6cZ_0">金币</p></a></div>
    <section class="profile-1reTe"><a href="javascript:;"
                                      class="index-2MEEn_0">
    ...
    <footer class="index-wrapper_1Rsz2pX">
      <div class="index-footer_Gtduid_"><a href="https://h5.ele.me/msite/"
                                           class="index-footerTab_bl0lbJN">
        <svg class="index-footerTabIcon_1EbB8wS">
          <use xmlns:xlink="http://www.w3.org/1999/xlink"
               xlink:href="#index-regular.b245d60"></use>
        </svg>
        <span class="index-footerTabText_1It8yh0">
        外卖
      </span></a><a href="https://h5.ele.me/discover/"
                    class="index-footerTab_bl0lbJN">
        <svg class="index-footerTabIcon_1EbB8wS">
          <use xmlns:xlink="http://www.w3.org/1999/xlink"
               xlink:href="#discover-regular.8ef537f"></use>
        </svg>
        <span class="index-footerTabText_1It8yh0">
        发现
      </span></a><a href="https://h5.ele.me/order/#/"
                    class="index-footerTab_bl0lbJN">
        <svg class="index-footerTabIcon_1EbB8wS">
          <use xmlns:xlink="http://www.w3.org/1999/xlink"
               xlink:href="#order-regular.41c17f8"></use>
        </svg>
        <span class="index-footerTabText_1It8yh0">
        订单
      </span></a><a href="https://h5.ele.me/profile/"
                    class="index-footerTab_bl0lbJN">
        <svg class="index-footerTabIcon_1EbB8wS">
          <use xmlns:xlink="http://www.w3.org/1999/xlink"
               xlink:href="#profile.dbc5ebf"></use>
        </svg>
